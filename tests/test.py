...
if __name__ == "__main__":
    ...
    # MINCC tests
    tf.expect_fail("""echo "void main(){1+}" | ./target/mincc""") # Incomplete expression
    tf.expect_fail("""echo "void main(){a+1=5;}" | ./target/mincc""") # Invalid assignment
    tf.expect_fail("""echo "void main(){i>=0;\nwhile(i<10) {\n i=i+1;\n if (i==5) {\nreturn 20*i;\n}\n\nreturn 0;}" | target/mincc """) # Missing closing brace

    # E2E tests
    tf.test_e2e("void main(){return 1+2;}", 3)
    tf.test_e2e("void main(){return 10-3;}", 7)
    tf.test_e2e("void main(){return 2*3;}", 6)
    tf.test_e2e("void main(){return (1+2)*3;}", 9)
    tf.test_e2e("void main(){return -3+5;}", 2)
    tf.test_e2e("void main(){return -(2+3)*4;}", -20)
    tf.test_e2e("void main(){return +5+(+3);}", 8)
    tf.test_e2e("void main(){return 1+1==2;}", 1)
    tf.test_e2e("void main(){return 1+1==3;}", 0)
    tf.test_e2e("void main(){return 2*2!=5;}", 1)
    tf.test_e2e("void main(){return (-2)*(-2)!=4;}", 0)
    tf.test_e2e("void main(){return (3+2<6)+(3+2<5);}", 1)
    ...
    tf.test_e2e("void main(){a=3;return a+2;}", 5)
    tf.test_e2e("void main(){a=2;b=3;return a*b;}", 6)
    tf.test_e2e("void main(){hoge=4;fuga=5;return hoge+fuga;}", 9)
    tf.test_e2e("void main(){a =1;\nb = 2;\nc  = 3;\nreturn a + b* c;}", 7)
    tf.test_e2e("void main(){hoge =3;\nfuga= hoge +2;\nif (fuga==5) return 42;\nreturn 0;}", 42)
    tf.test_e2e("void main(){hoge=2; fuga = 3;\nif (hoge != 0) if (hoge+fuga > 3) return 2;\nelse return 0;}", 2)
    tf.test_e2e("void main(){sum=0;\nfor(i=1;i<5;i=i+1) sum=sum+i;\nreturn sum;}", 10)
    tf.test_e2e("void main(){i=0;\nwhile(i<3) i=i+1;\nreturn i;}", 3)
    tf.test_e2e("void main(){i=0;\nwhile(i<10) {\n i=i+1;\n if (i==5) {\nreturn 20*i;\n}\n}\nreturn 0;}", 100)
    tf.test_e2e("char gvar=10;\nvoid main(){return gvar+5;}", 15, verbose=True)
    tf.test_e2e("char global_var=0;\nvoid main(){while(global_var<21){for (i=1;i<5;i=i+1) global_var=global_var+i;}\nreturn global_var;}", 30)
    ...
    tf.test_e2e("void main(){j=0;for(i=0;i<7;i=i+1){} k=0; i=i+5; return i;}", -1)
