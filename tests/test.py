...
if __name__ == "__main__":
    ...
    tf.test_e2e("void main(){int hoge =3;int fuga= hoge +2;if (fuga==5) return 42;return 0;}", 42)
    tf.test_e2e("void main(){int hoge=2; int fuga = 3;if (hoge != 0) if (hoge+fuga > 3) return 2;else return 0;}", 2)
    tf.test_e2e("void main(){int sum=0;\nfor(int i=1;i<5;i=i+1) sum=sum+i;\nreturn sum;}", 10)
    tf.test_e2e("void main(){int i=0;\nwhile(i<3) i=i+1;\nreturn i;}", 3)
    tf.test_e2e("void main(){int i=0;\nwhile(i<10) {\n i=i+1;\n if (i==5) {\nreturn 20*i;\n}\n}\nreturn 0;}", 100)
