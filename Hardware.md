...
| stm X+n,rs | 0100 nnnn ssss nnnn | [{r13, r12}+n] = rs                     |
| ldm rd,X+n | 0101 nnnn dddd nnnn | rd = [{r13, r12}+n]                     |
| stm Y+n,rs | 0110 nnnn ssss nnnn | [{r15, r14}+n] = rs                     |
| ldm rd,Y+n | 0111 nnnn dddd nnnn | rd = [{r15, r14}+n]                     |
| jz n,rs    | 1000 nnnn ssss nnnn | PC = n if rd == 0                       |
| jnz n,rs   | 1001 nnnn ssss nnnn | PC = n if rd != 0                       |
| calr n     | 1011 nnnn rrrr nnnn | (----SP) = PC + 1;PC = PC + {r, n} + 1  |
| jr n       | 1011 nnnn rrrr nnnn | (----SP) = PC + 1;PC = PC + {r, n} + 1  |
| jp m       | 110100 00 0000 0000 | PC = m                                  |
| call m     | 111010 00 0000 0000 | (----SP) = PC + 1;PC = m                |
| ret        | 111011 00 0000 0000 | PC = (SP);SP = SP + 2;                  |
| mvi rd,n   | 1111 nnnn dddd nnnn | rd = n                                  |
